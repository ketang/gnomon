...
impl App {
    ...
    fn apply_row_filter(&mut self) {
        ...
        self.apply_row_filter_with_selected_key(selected_key);
    }
    ...
    fn apply_loaded_view(&mut self, loaded_view: LoadedView) {
        ...
        self.apply_row_filter_with_selected_key(loaded_view.selected_key);
        self.save_state();
    }

    fn apply_row_filter_with_selected_key(&mut self, preferred_key: Option<String>) {
