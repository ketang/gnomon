...
fn resolve_cache_misses_parallel(
    ...
    identity_policy: &ProjectIdentityPolicy,
    project_filters: &[ProjectFilterRule],
    cached_rows_by_root: &HashMap<String, HashMap<(String, String, String), StoredScanCacheRecord>>,
    ...
    misses
        ...
        .map(|candidate| {
            ...
            let previous = cached_rows_by_root
                .get(&candidate.scan_root_path)
                .and_then(|cached_rows| cached_rows.get(&cache_key));
